...
# 07/04/2026
#
# PROGRAM: trainA__2.py

# Approach A:
# This program loades a raw dataset. Known Semiempirical Mass Formula terms are pre-computed and 
# build into a new dataset, the train dataset.
# The regressor must find the structure that fits this pre-computed terms.
# Run >> python trainA__2.py << in terminal to do so.

# It saves the model output for analysis.
# To use the model load it as: 
# pysr_model=PySRRegressor.from_file(r"C:\Users\Lauri\Desktop\TFG-code\results\models\trainA__2\{}")
#                                                                                     -> the model folder.
...
# Exclude very light nuclei (N,Z< 8): shell efects important.
df=raw_df[((raw_df["A"]-raw_df["Z"])>=8)&(raw_df["Z"]>=8)]

# -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-. Variables. [A,Z,N, ...] -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-. 
# Include pre-computed variables for an easier find. [A^1/3 , Z**2, (A-2Z)^2, pairing delta] 
...
pysr_model=PySRRegressor(
    ...
    **SE_pysr_params,
    output_directory=r"C:\Users\Lauri\Desktop\TFG-code\results\models\trainA__2"
)

# -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-. Fit the model -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.

print("-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-. Ready to start -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.")
pysr_model.fit(X,BE_per_A)